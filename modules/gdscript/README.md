...
- GDScript decompilation is found in [`gdscript_disassembler.cpp`](modules/gdscript/gdscript_disassembler.cpp), defined as `GDScriptFunction::disassemble()`.
